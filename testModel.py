...
ap.add_argument("-v", "--video", help="Testing Video Path", default="videos/7.avi")
...
while(True):
    ...
    for f in rects:
        ...
        (notyawning, yawning) = model.predict(roi)[0]
        label = "Yawning" if yawning > notyawning else "Normal"
